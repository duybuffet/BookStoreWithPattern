...
public class MySqlUserDAO implements UserDAO {
    ...
    public void addUser(User u) throws SQLException {
        ...
        /* insert address */
        ps = MysqlDbConnect.getConnection().prepareStatement(queryInsertAddress);
        ...
        /* insert name surname */
        ps = MysqlDbConnect.getConnection().prepareStatement(queryInsertName);
        ...
        /* insert user */
        ps = MysqlDbConnect.getConnection().prepareStatement(queryInsertUser);
